...
| backend-lifecycle-api | `codex/oa-platform-production` | main workspace | Codex | in progress | Task 4 lifecycle/runtime API |
...
- Backend packaging: `mvn -pl yudao-server -am -DskipTests package` succeeds after Task 3 integration.
