...
export enum CandidateStrategy {
   ...
   * 发起人公司指定职务
   */
  START_USER_COMPANY_JOB_POSITION = 56,
  /**
   * 表单内用户字段
   */
  FORM_USER = 50,
...
export const CANDIDATE_STRATEGY: DictDataType[] = [
  ...
  {
    label: '发起人公司指定岗位',
    value: CandidateStrategy.START_USER_COMPANY_POST as any,
  },
  {
    label: '发起人公司指定职务',
    value: CandidateStrategy.START_USER_COMPANY_JOB_POSITION as any,
  },
