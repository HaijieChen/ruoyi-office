...
public class BpmTaskCandidateStartUserDeptLeaderStrategy extends AbstractBpmTaskCandidateDeptLeaderStrategy {
    ...
    public Set<Long> calculateUsersByTask(DelegateExecution execution, String param) {
        ...
        // 获取发起人的部门负责人
        return getStartUserDeptLeader(startUserId, param, execution.getVariables());
    }
    ...
    private Set<Long> getStartUserDeptLeader(Long startUserId, String param, Map<String, Object> processVariables) {
