...
/**
 * 勾选多个部门，只取发起任职公司下对应部门的负责人。
 */
@Component
public class BpmTaskCandidateStartUserCompanyDeptLeaderStrategy implements BpmTaskCandidateStrategy {
    ...
    public BpmTaskCandidateStrategyEnum getStrategy() {
        return BpmTaskCandidateStrategyEnum.START_USER_COMPANY_DEPT_LEADER;
    }
    ...
    Set<Long> resolve(String param, Long startUserId, Map<String, Object> processVariables) {
        ...
        return BpmStartCompanyDeptSupport.leaderUserIds(
                deptApi.getDeptList(matched).getCheckedData());
    }
}
