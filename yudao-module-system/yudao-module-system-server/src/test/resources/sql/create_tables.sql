CREATE TABLE IF NOT EXISTS "system_dept" (
    ...
    "functional_currency" varchar(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "system_mfa_control_state" (
    ...
    "global_mode" varchar NOT NULL DEFAULT 'OFF',
    "global_allowed_factors" varchar,
    "global_policy_epoch" bigint NOT NULL DEFAULT 0,
    "global_min_accepted_epoch" bigint NOT NULL DEFAULT 0,
    "armed_at" datetime,
    "checksum" varchar,
    "creator" varchar DEFAULT '',
    "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "system_mfa_user_assurance" (
    ...
    "enrollment_state" varchar NOT NULL DEFAULT 'NONE',
    "preferred_factor_id" bigint,
...
CREATE TABLE IF NOT EXISTS "system_mfa_auth_flow" (
    ...
    "assurance_epoch" bigint NOT NULL DEFAULT 0,
    "allowed_actions" varchar,
    "allowed_factor_ids" varchar,
