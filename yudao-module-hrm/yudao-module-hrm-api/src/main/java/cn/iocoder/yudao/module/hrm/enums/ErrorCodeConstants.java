...
public interface ErrorCodeConstants {
    ...
    ErrorCode EMPLOYEE_ROSTER_SOCIAL_SECURITY_MONTH = new ErrorCode(1_050_001_006,
            "缴纳社保时必须填写参保年月（正确示例：2024-01）");
    ErrorCode EMPLOYEE_ROSTER_SOCIAL_SECURITY_MONTH_FORMAT = new ErrorCode(1_050_001_007,
            "参保年月格式不正确，须为 yyyy-MM（正确示例：2024-01；也可用 2024/01、202401）");
    ErrorCode EMPLOYEE_ROSTER_SALARY_NEGATIVE = new ErrorCode(1_050_001_008, "薪资不能为负数");
    ErrorCode EMPLOYEE_ROSTER_CONTRACT_START_REQUIRED = new ErrorCode(1_050_001_009,
    ...
    ErrorCode EMPLOYEE_EMPLOYMENT_DEPT_REQUIRED = new ErrorCode(1_050_001_018, "任职部门不能为空");
    ErrorCode EMPLOYEE_EMPLOYMENT_DEPT_NOT_UNDER_COMPANY = new ErrorCode(1_050_001_019, "任职部门必须属于所选公司");
